  ...
  return (
    <div className="bg-surface text-on-surface font-body-md pt-32 pb-section-gap max-w-container-max mx-auto px-margin-desktop">
      ...
      <div className="text-center py-20">
        <h1 className="font-headline-md text-headline-sm mb-4">Secure Checkout</h1>
        <p className="font-body-md text-on-surface-variant">Checkout page under construction</p>
      </div>
    </div>
  )
}
