  ...
  return (
    <div className="bg-surface text-on-surface font-body-md pt-32 pb-section-gap max-w-container-max mx-auto px-margin-desktop">
      ...
      <div className="text-center py-20">
        <h1 className="font-headline-md text-headline-sm mb-4">Admin Dashboard</h1>
        <p className="font-body-md text-on-surface-variant">Admin page under construction</p>
      </div>
    </div>
  )
}
