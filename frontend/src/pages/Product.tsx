          ...
          <div className="lg:col-span-5 lg:pl-12 flex flex-col gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="relative group">
                <input className="w-full border-b border-primary bg-transparent py-3 font-body-md outline-none focus:border-secondary transition-colors cursor-pointer appearance-none" type="date" />
            ...
            <div className="flex flex-col gap-4 pt-4">
              <button className="bg-primary text-on-primary py-5 font-label-caps text-label-caps hover:bg-transparent hover:text-primary border border-primary transition-all">ADD TO CART</button>
              <button className="bg-secondary-container text-on-secondary-container py-5 font-label-caps text-label-caps hover:opacity-90 transition-all">BUY NOW</button>
            </div>
